...
const ElementSymbol: React.FC<ElementSymbolProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="border-4 border-gray-800 rounded-lg p-6 bg-white w-52 h-52 flex flex-col justify-center items-center shadow-lg">
        ...
        {showDetails && (
          <>
            <div className="text-md mt-1 font-semibold">{element.name}</div>
